 ...
 */
$config['site_domain'] = '/next/site/';
$config['url_padrao'] = 'http://www.nextsolucoesimobiliarias.com.br/index.php';

/* 
 * MY info
 */
$config['site_name'] = 'Next Imoveis';
$config['site_email'] = 'rapricardo@gmail.com';
$config['desenvolvimento'] = 'Desenvolvimento <a href="http://www.heat.com.br/desenvolvimento-e-criacao-de-sites/" >Heat criação de sites</a>.';
...
(
	 //MODPATH.'imoveis', // Imoveis
  	 MODPATH.'auth',     
	 MODPATH.'tools', // Unit testing
);